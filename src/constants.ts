...
// Pivot tables shared across users
export const SHARED_NAME_COLLECTIONS = new Set(['tags', 'ingredients', 'units'])
...
export const LAST_VIEWED_STORAGE_KEY = 'rcps-app-last-viewed'
...
export const DEFAULT_USER_SETTINGS: Omit<
  UserSettings,
  'theme' | 'accentDark' | 'accentLight' | 'updatedAt'
> = {
  keepScreenOn: true,
}
